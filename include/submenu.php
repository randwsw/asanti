		...
		<div class="sub-menu" id="sub-menu-girl">
			...
			<ul class="sub-menu-anim" id="sub-menu-anim-g">
				...
				while($rec = mysqli_fetch_array($sql)) {
					...
					echo("<a href='store.php?category=".$rec['urlName']."-4'><div class='menu-div'>".$rec['name']."</div></a></li>");
					}		
				?>
		...
		<div class="sub-menu" id="sub-menu-boy">
			...
			<ul class="sub-menu-anim" id="sub-menu-anim-b">
				...
				while($rec = mysqli_fetch_array($sql)) {
					...
					echo("<a href='store.php?category=".$rec['urlName']."-5'><div class='menu-div'>".$rec['name']."</div></a></li>");
					}
...
<script type="text/javascript">
	...
	$("#female").click(function(){
		window.location.href = "store.php?category=dla_dziewczynki";
	});
	$("#male").click(function(){
		window.location.href = "store.php?category=dla_chlopca";
	});
</script>